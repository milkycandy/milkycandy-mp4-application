...
void Dialog::create_ui(lv_obj_t* parent, const std::string& title, const std::string& text, bool is_dual_button, const std::string& positive_text, const std::string& negative_text) {
    ...
    lv_obj_set_style_text_font(ui_title, FontManager::getDemibold(22), 0);
    ...
    lv_obj_set_style_text_font(ui_text, FontManager::getDemibold(22), 0);
    ...
    if (is_dual_button) {
        ...
        lv_obj_set_style_text_font(label_neg, FontManager::getDemibold(22), 0);
        ...
        lv_obj_set_style_text_font(label_pos, FontManager::getDemibold(22), 0);
